...
import { ArrowUp, ArrowDown, ArrowLeft, ArrowRight, Droplets, SettingsIcon, Bell, Info, Zap } from "lucide-react"
    ...
    <div className="min-h-screen p-4 md:p-6 relative">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="text-center mb-8">
          <h1 className="text-3xl md:text-4xl font-bold mb-2 text-balance">Panel de Control</h1>
          <p className="text-muted-foreground">Gestiona tu sistema de riego inteligente</p>
        </div>
        ...
        <Card className="p-6 bg-gradient-to-br from-card to-accent/30">
          <h2 className="text-xl font-semibold mb-4 text-balance">Sistema de Riego</h2>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-3">
              ...
              <p className="text-xs text-muted-foreground">{duration[0]} segundos</p>
            ...
            <div className="flex items-center justify-between p-4 bg-accent/50 rounded-lg">
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">Riego basado en sensores</p>
                </div>
              </div>
        ...
        <Card className="p-6 bg-gradient-to-br from-card to-accent/30">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-balance">Control del Brazo</h2>
            <Badge variant="secondary" className="text-xs">
              Próximamente
            </Badge>
          </div>
          <p className="text-sm text-muted-foreground mb-6">Hardware en desarrollo - Funcionalidad disponible pronto</p>

          <div className="grid grid-cols-3 gap-3 max-w-xs mx-auto">
            <div />
            <Button variant="outline" disabled className="opacity-50 h-16 bg-transparent">
        ...
        <Card className="p-6 bg-gradient-to-br from-card to-accent/30">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-xl font-semibold text-balance">Selección de Maceta</h2>
            <Badge variant="secondary" className="text-xs">
              Beta
            </Badge>
          </div>
          ...
          <div className="grid grid-cols-3 md:grid-cols-6 gap-3">
            {[1, 2, 3, 4, 5, 6].map((pot) => (
              <Button
                ...
                disabled
                className={cn("h-20 w-full opacity-50", selectedPot === pot && "pulse-glow-animation")}
        ...
        {/* Settings */}
        <Card className="p-6 bg-gradient-to-br from-card to-accent/30">
          <h2 className="text-xl font-semibold mb-4 text-balance">Configuración</h2>
        ...
        {irrigationStatus && (
          <Card className="p-4 bg-accent/50">
            <p className="text-sm text-center text-muted-foreground">
              Estado: {irrigationStatus.isActive ? "Regando..." : "Inactivo"} | Último riego:{" "}
